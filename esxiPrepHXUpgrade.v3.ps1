	...
	Switch ($choice) {
		...
		2 {
            ...
            ForEach ($global:vmHost in $global:vmHosts) {
                ...
                Try{
                    ...
                    Select-Object VMHost,Label,Running
                }
        ...
        4 {
            ...
            ForEach ($global:vmHost in $global:vmHosts) {
                ...
                Try{
                    ...
                    Set-VMHostService -policy "On" | Select-Object VMHost,Label,Policy
                }
		...
		8 {
            ...
            ForEach ($global:vmHost in $global:vmHosts) {
                ...
                Try{
                    Get-VMHost $global:vmHost | Get-VMHostService | Where-Object {$_.key -eq "TSM-SSH"} | 
                    Set-VMHostService -policy "Off" | Select-Object VMHost,Label,Policy
                }
